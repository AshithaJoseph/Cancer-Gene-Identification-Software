...
public class BarChartDemo3 extends ApplicationFrame {
     ...
     */
    public BarChartDemo3(final String title,ArrayList ar) {
    ...
    private CategoryDataset createDataset(ArrayList arr) {
        ...
        // column keys...
        final String category1 = "0-20";
        final String category2 = "21-40";
        final String category3 = "41-60";
        final String category4 = "61-80";
        final String category5 = "81-100";
        final String category6 = "101-";
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "Betweenness Analysis",         // chart title
