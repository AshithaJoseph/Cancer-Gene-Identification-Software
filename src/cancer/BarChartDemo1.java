...
public class BarChartDemo1 extends ApplicationFrame {
     ...
     */
    public BarChartDemo1(final String title,ArrayList ar) {
 ...
 setDefaultCloseOperation(DISPOSE_ON_CLOSE);
    ...
    private CategoryDataset createDataset(ArrayList arr) {
        ...
        // column keys...
        final String category1 = "1-30";
        final String category2 = "31-60";
        final String category3 = "61-90";
        final String category4 = "91-120";
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "Shortest Path Analysis",         // chart title
