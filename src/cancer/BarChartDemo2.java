...
public class BarChartDemo2 extends ApplicationFrame {
     ...
     */
    public BarChartDemo2(final String title,ArrayList ar) {
 ...
 setDefaultCloseOperation(DISPOSE_ON_CLOSE);
    ...
    private CategoryDataset createDataset(ArrayList arr) {
        ...
        // column keys...
        final String category1 = "0-.2";
        final String category2 = ".2-.4";
        final String category3 = ".4-.6";
        final String category4 = ".6-.8";
    ...
    private JFreeChart createChart(final CategoryDataset dataset) {
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "Clustering coeff analysis",         // chart title
